...
<body>
    ...
    <!-- Update Enseignant Form -->
    <div class="form-container">
        <div class="form-card">
            <div class="card shadow-sm p-4">
                <h2 class="card-title text-center mb-4">Update Enseignant</h2>
                <?php
                $matricule = htmlspecialchars($ens['matricule']);
                $nom = htmlspecialchars($ens['nom']);
                $prenom = htmlspecialchars($ens['prenom']);
                ?>
                <form action="/enseignant/update" method="POST">
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Update Enseignant
                        </button>
                    </div>
                </form>
            </div>
