     ...
     <div class="row">
         <div class="col-md-6 m-auto">
             ...
             <table class="table table-striped border my-5px">
                     ...
                     <?php
                        foreach ($ensList as $row) {
                            ...
                            <tr>
                                ...
                                <td>{$row['prenom']}</td>
                                <td>
                                 <a href="/enseignant/update?matricule={$row['matricule']}">Update</a>
                                </td>
                                <td>
                                    <form action="/enseignant/delete" method="POST">
                                        <input type="hidden" id="matricule" name="matricule" value="{$row['matricule']}" >
                 ...
                 <a href="/enseignant/add">Ajouter Enseignant</a>
         </div>
     </div>
 </body>
